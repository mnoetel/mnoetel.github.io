...
#let pub-entry(pub) = {
  ...
  block(above: 0.8em, below: 0.4em)[
    #text(size: 0.85em)[
      ...
      #linebreak()
      #text(fill: luma(80), style: "italic")[#pub.journal]
      #if parts.len() > 0 {
...
#resume-item[
  ...
  - *Public science communicator*: 8 _Conversation_ articles (210K reads); media interviews for CNN, BBC, ABC, The Times, including TV and live radio; invited to brief federal parliamentarians.
...
#grant-entry("AI Risk Index: Assessing influential organizations' responses to risks from AI", "Subaward with MIT", "2025–2026", [\$340,660])
...
#grant-entry("Other grants (iPLAY, SPIKE, nutrition, TWM)", "Sport Australia / NSW DoE / QAS", "2018–2019", [\$188,744])
...
#block(above: 1em, below: 0.6em)[
  ...
  #text(size: 0.9em, fill: luma(80))[#link("https://10.com.au/news/national/experts-warn-artificial-intelligence-will-lead-to-human-extinction-10-news/tpv251114zhrma")[Ten News], #link("https://www.smartcompany.com.au/artificial-intelligence/aussies-concerned-ai-risk-government/")[SmartCompany], #link("https://theconversation.com/80-of-australians-think-ai-risk-is-a-global-priority-the-government-needs-to-step-up-225175")[The Conversation]]
]
...
#block(above: 1em, below: 0.6em)[
  ...
  #text(size: 0.9em, fill: luma(80))[#link("https://www.abc.net.au/religion/the-case-for-effective-altruism/13359912")[ABC Religion & Ethics], #link("https://www.abc.net.au/news/2022-01-09/are-we-making-a-difference-when-we-donate-to-charity/100722158")[ABC Radio National]]
]
...
#block(above: 1em, below: 0.6em)[
  #grid(
    columns: (1fr, auto),
    align: (left, right),
    text(weight: "bold")[Vigorous exercise during pregnancy],
    text[2019],
  )
  #text(size: 0.9em, fill: luma(80))[#link("https://www.washingtonpost.com/health/vigorous-exercise-in-the-third-trimester-is-it-safe/2019/10/18/de5de322-e53d-11e9-b403-f738899982d2_story.html")[The Washington Post], #link("https://theconversation.com/is-vigorous-exercise-safe-during-the-third-trimester-of-pregnancy-121762")[The Conversation]]
]
...
#resume-entry(
  ...
  location: "",
  date: "2019–Present",
  description: "Asghar Ahmadi, Roberta Vasconcellos, Shantell Griffith, Ghassani Swaryandini, Gerard Hassed",
)
#resume-entry(
  title: "PhD Associate Supervisor",
  location: "",
  date: "2021–Present",
  description: "Brynlea Gibson, Lena Hall, Anum Urooj, Ella Tremaine",
)
#resume-entry(
...
#resume-entry(
  ...
  date: "2021–Present",
  description: [Stewarding AU\$5M+/yr to cost-effective programs],
)
#resume-entry(
